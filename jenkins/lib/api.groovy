 ...
 * Used for markings in the standard output (Logs from build, tests, system_info, etc. are stored additionally on tested server - for later usage and archiving purposes).
