...
function usage()
{
	...
	echo "--master_repo    Github repo address of pmemstream master [default: $PMEMSTREAM_MASTER_ADDR]"
	echo "--master_commit  Commit or branch for master [default: $PMEMSTREAM_MASTER_COMMIT]"
	echo "--compare_repo   Github repo address of pmemstream for comparing. [default: $PMEMSTREAM_MASTER_ADDR]"
}
